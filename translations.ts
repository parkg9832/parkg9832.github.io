    ...
    products: {
      ...
      items: {
        original: {
          category: 'Gochujang',
          title: 'Original',
          descLine1: 'Elevated with a fresh hint of jalapeño,',
          descLine2: 'Clean, crisp Korean heat',
        },
        ssamjang: {
          category: 'Ssamjang',
          title: 'Para Carne',
          descLine1: 'Masterfully crafted for meats and grilling,',
          descLine2: 'Rich, savory BBQ sauce',
        },
        soySauce: {
          category: 'Ganjang',
          title: 'Soy Sauce',
          descLine1: 'Sweet and savory in perfect balance,',
          descLine2: 'Your go-to fusion daily sauce',
        },
      },
    },
    ourStory: {
    ...
    products: {
      ...
      items: {
        original: {
          category: 'Gochujang',
          title: 'Original',
          descLine1: 'Elevado con un toque fresco de jalapeño,',
          descLine2: 'Un picante limpio y coreano',
        },
        ssamjang: {
          category: 'Ssamjang',
          title: 'Para Carne',
          descLine1: 'Creada especialmente para carnes y asados,',
          descLine2: 'Salsa BBQ de un profundo y sabroso umami',
        },
        soySauce: {
          category: 'Ganjang',
          title: 'Soy Sauce',
          descLine1: 'El equilibrio perfecto entre dulce y salado,',
