      ...
      const localizedProducts = [
        {
          ...
          foodImage: 'assets/images/kpeno-food-product-centered-20260922.webp',
          textureImage: 'assets/images/kpeno-food-product-centered-20260922.webp',
          panelTone: '#ef5f18',
        ...
        },
        {
          ...
          foodImage: 'assets/images/para-carnes-food-product-centered-20260922.webp',
          textureImage: 'assets/images/para-carnes-food-product-centered-20260922.webp',
          panelTone: '#381607',
        ...
        document.getElementById('productsGrid').innerHTML = items
          ...
          .map(
            (item, index) => {
              ...
              return `
              <a href="${['kpeno.html', 'para-carnes.html'][index] || 'products.html'}" data-product="${name}" data-reveal data-reveal-delay="${index * 120}" class="product-photo-card group flex min-w-0 flex-col overflow-hidden rounded-[1.2rem] bg-white text-left transition-all duration-300">
