    ...
    <section className="bg-neutral-50 px-5 py-24 sm:px-8 sm:py-32 lg:px-12 lg:py-40">
      <div className="mx-auto max-w-7xl">
        <div className="mb-14 max-w-4xl">
          <p className="mb-5 text-xs font-extrabold uppercase tracking-[0.32em] text-[#ef5f18]">
            Brand Highlights
          </p>
          <h2 className="text-balance text-5xl font-extrabold leading-none tracking-tight text-neutral-950 sm:text-6xl lg:text-7xl">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {features.map((feature) => {
            ...
            return (
              <article
                key={feature.title}
                className="surface-depth group min-h-[300px] rounded-[2rem] border border-neutral-200 bg-white p-7 transition-all duration-300 hover:-translate-y-1 hover:border-[#ef5f18]/40 sm:p-9"
              >
