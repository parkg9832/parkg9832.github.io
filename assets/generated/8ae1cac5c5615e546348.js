        ...
        document.getElementById('productsGrid').innerHTML = items
          ...
          .map(
            (item, index) => {
              ...
              return `
              <a href="/en/products.html#${['original', 'para-carnes'][index] || ''}" data-product="${name}" data-reveal data-reveal-delay="${index * 120}" class="product-photo-card group flex min-w-0 flex-col overflow-hidden rounded-[1.2rem] bg-white text-left transition-all duration-300">
