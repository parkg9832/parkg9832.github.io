  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-neutral-950 px-5 py-28 text-center text-white sm:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-5xl pt-20">
        <p className="hero-kicker-shadow mb-6 text-xs font-extrabold uppercase tracking-[0.34em] text-[#ef5f18] sm:text-sm">
          MOKDA Brand Essence
        </p>
        <h1 className="hero-title-shadow break-keep text-balance text-6xl font-black leading-[0.9] tracking-tight sm:text-7xl md:text-8xl lg:text-9xl">
          Comer Corea
          <br />
