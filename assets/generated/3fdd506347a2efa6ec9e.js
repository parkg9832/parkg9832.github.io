      ...
      const qnaItems = [
        ...
        },
        {
          ES: {
            ...
            answer: 'K-PEÑO combina una base de gochujang con un toque fresco de jalapeño. Para Carnes parte del ssamjang y acompaña carnes y verduras con un umami profundo.',
          },
          EN: {
            question: 'Which products are in the Salsa Coreana line?',
            answer: 'K-PEÑO blends a gochujang base with a fresh jalapeño lift. Para Carnes is ssamjang-based and brings deep umami to meat and vegetables.',
          },
          KR: {
            question: 'Salsa Coreana에는 어떤 제품이 있나요?',
            answer: 'K-PEÑO는 고추장에 할라피뇨의 산뜻함을 더한 소스입니다. Para Carnes는 고기와 채소에 깊은 감칠맛을 더하는 쌈장 기반의 한국 소스입니다.',
          },
        },
        {
          ES: {
            question: '¿Con qué comidas se pueden usar las salsas?',
            answer: 'K-PEÑO va bien con pollo, nachos, empanadas, pizza, carne y tacos. Para Carnes acompaña carnes asadas, al vapor o cocidas, además de verduras como pepino y pimiento.',
          },
          EN: {
            question: 'What foods can the sauces be used with?',
            answer: 'K-PEÑO pairs with chicken, nachos, empanadas, pizza, meat, and tacos. Para Carnes complements grilled, steamed, or boiled meat, as well as vegetables such as cucumber and bell pepper.',
          },
          KR: {
            question: '어떤 음식에 활용할 수 있나요?',
            answer: 'K-PEÑO는 치킨, 나초, 엠빠나다, 피자, 고기, 타코 등에 잘 어울립니다. Para Carnes는 구운 고기, 찐 고기, 삶은 고기와 오이, 파프리카 등 고기와 채소에 곁들이기 좋습니다.',
          },
        },
        {
          ES: {
            question: '¿Dónde puedo consultar disponibilidad, ingredientes y alérgenos?',
            answer: 'La disponibilidad puede variar según el mercado. Consulta la información de cada salsa en su página de producto y las indicaciones de ingredientes, alérgenos y conservación en su envase. Para confirmar disponibilidad o resolver dudas sobre tu mercado, utiliza la página de contacto.',
          },
          EN: {
            question: 'Where can I check availability, ingredients, and allergens?',
            answer: 'Availability may vary by market. Visit each product page for details and check the packaging for ingredient, allergen, and storage information. Use the contact page to confirm availability or ask market-specific questions.',
          },
          KR: {
            question: '판매 여부, 원재료와 알레르겐 정보는 어디서 확인하나요?',
            answer: '판매 여부는 시장별로 달라질 수 있습니다. 제품 상세 페이지에서 제품 정보를 확인하고, 원재료·알레르겐·보관 정보는 제품 패키지의 표기를 확인해주세요. 시장별 판매 여부나 추가 정보는 문의 페이지로 확인하실 수 있습니다.',
          },
        },
        {
          ES: {
