      ...
      const content = {
        ES: {
          ...
          hero: {
            ...
            description: 'Consultas para distribución, importación, retail, HORECA y colaboraciones de negocio en Latinoamérica. También recibimos consultas generales sobre nuestros productos.',
          },
          fields: {
            name: ['Nombre', 'Nombre completo'],
            email: ['Correo electrónico', 'nombre@empresa.com'],
            whatsapp: ['WhatsApp', 'Número con código de país (+...)'],
            country: ['País / Mercado', 'Selecciona un país'],
            purpose: ['Tipo de consulta', 'Opcional', ['Distribuidor', 'Importador', 'Retail', 'HORECA', 'Consulta general', 'Otro']],
            company: ['Empresa (opcional)', 'Nombre de la empresa, si corresponde'],
            message: ['Mensaje', 'Cuéntanos tu consulta o propuesta'],
        ...
        EN: {
          ...
          hero: {
            ...
            description: 'For distribution, import, retail, HORECA, and business partnerships across Latin America. General product questions are also welcome.',
          },
          fields: {
            name: ['Name', 'Full name'],
            ...
            purpose: ['Inquiry type', 'Optional', ['Distributor', 'Importer', 'Retail', 'HORECA', 'General inquiry', 'Other']],
            company: ['Company (optional)', 'Company name, if applicable'],
            message: ['Message', 'Tell us your question or proposal'],
            submit: 'Send inquiry',
        ...
        KR: {
          ...
          hero: {
            ...
            description: '라틴아메리카 유통, 수입, 리테일, HORECA 및 사업 협력 문의를 받습니다. 제품에 관한 일반 문의도 보내실 수 있습니다.',
          },
          fields: {
            name: ['이름', '이름을 입력해주세요'],
            email: ['이메일', 'name@company.com'],
            whatsapp: ['WhatsApp', '국가번호를 포함한 전화번호 (+...)'],
            country: ['국가 / 시장', '국가 선택'],
            purpose: ['문의 유형', '선택 입력', ['유통사', '수입사', '리테일', 'HORECA', '일반 문의', '기타']],
            company: ['회사명 (선택)', '회사가 있는 경우 입력해주세요'],
            message: ['문의 내용', '궁금한 점이나 사업 제안을 적어주세요'],
            submit: '문의 보내기',
            required: '필수 항목입니다.',
